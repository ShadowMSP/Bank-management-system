...
public final class Practice {
    ...
    /**
     * Create a new string and assign to it a string based on the gray-scale value.
     * If the gray-scale value is very high, the pixel is very bright and assign characters
     * such as . and , that do not appear very dark. If the gray-scale value is very low the pixel is very dark,
