...
public class Signup3 extends JFrame implements ActionListener{
    ...
    Signup3(String formno){
        ...
        l5 = new JLabel("(Your 16-digit Card number(sample))");
        ...
        l9.setFont(new Font("Raleway", Font.BOLD, 10));
         ...
         l = new JLabel("(Never disclose it to others)");
        l.setFont(new Font("Raleway", Font.BOLD, 10));
